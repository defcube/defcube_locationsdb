...
('IR', 'IRN', '364', ('Iran')), ('IQ', 'IRQ', '368', ('Iraq')),
...
("KE", "Kenya"), ("KI", "Kiribati"), ("KR", "Korea, Republic of"),
("KW", "Kuwait"), ("KG", "Kyrgyzstan"),
("LA", "Lao People's Democratic Republic"), ("LV", "Latvia"), ("LB", "Lebanon"),
("LS", "Lesotho"), ("LY", "Libyan Arab Jamahiriya"), ("LI", "Liechtenstein"),
...
("ES", "Spain"), ("LK", "Sri Lanka"), ("SR", "Suriname"),
("SJ", "Svalbard and Jan Mayen"), ("SZ", "Swaziland"), ("SE", "Sweden"),
("CH", "Switzerland"), ("TW", "Taiwan, Province of China"),
